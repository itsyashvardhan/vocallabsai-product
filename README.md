...
| Deck | Walkthrough slides (open in any browser) | **[deck/index.html](deck/index.html)** |
...
2. **GTM / Pricing** `[Critical]`: `/pricing` **404s**, yet the app's Wallet shows a real **₹1 = 1 credit** model. And there are **two separate paywalls** (credits and "plan access"); pay ₹100 and you still can't build.
...
Logged into `app.vocallabs.ai` as a fresh account (v2.1.6) and traced the activation funnel; read `docs.vocallabs.ai` for the monetization model the site hides; benchmarked 8 competitors including India-native players. Every claim is screenshotted or cited; no invented numbers.
